...
def fooldal(movie):
    ...
    btn_avatar = ttk.Button(fooldal1, text=avatar_cim,image=avatar_image,compound=BOTTOM, bootstyle="light-outline", command= res.start(0)).grid(row=2, column=2, padx=(5,5))
